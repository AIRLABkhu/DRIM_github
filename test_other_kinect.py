...
if __name__ == "__main__":
    ...
    # Datasets
    parser.add_argument('--image_dir', type=str, default='/DRIM/raw_dataset/testsets/other_kinect/depth')
    parser.add_argument('--gt_dir', type=str, default='/DRIM/raw_dataset/testsets/other_kinect/gt')
    parser.add_argument('--inter_mask_dir', type=str, default='/DRIM/raw_dataset/testsets/other_kinect/inter_artifact_mask')
    parser.add_argument('--sensor_mask_dir', type=str, default='/DRIM/raw_dataset/testsets/other_kinect/sensor_artifact_mask')
    # Training Setting
